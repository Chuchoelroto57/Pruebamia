package buenardo;
import java.awt.*;//Proporciona las herramientas para un entorno gráfico
import java.awt.event.*;//Proporciona interfaces y clases para lidiar con diferentes tipos de eventos desencadenados por componentes de AWT.
import javax.swing.*;//En pocas palabras amplia las funcionalidades de awt.


public class Buenardo extends JFrame implements KeyListener {
    int pos[]={0,1};
    ...
    public Buenardo(){
        ...
        b= new JButton [m][n];
        setLayout(new GridLayout(n,m));//Grid Layout x and y are SWAPPED!
        for(int y = 0;y<n;y++){
            for(int x=0;x<m;x++){
                b[x][y]=new JButton("");
